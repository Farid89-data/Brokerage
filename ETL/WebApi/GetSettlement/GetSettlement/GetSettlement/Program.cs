...
namespace GetSettlement
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string UrlLink = String.Format("http://automationapi.mobinsb.ir/api/External/Cash/GetSettlement?FromDate={0}&ToDate={1}&PageSize={2}&PageNumber={3}", StartDate, EndDate, WPageSize, WPage);
