...
namespace GetRequestMasterStockMarket
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string UrlLink = String.Format("http://automationapi.mobinsb.com/api/external/Bourse/CustomerElectronicRequestAccountV2?PageSize={2}&PageNumber={3}&FromDate={0}&ToDate={1}", StartDate, EndDate, WPageSize, WPage);
