...
namespace GetRequestMasterStockMarket
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            int WPageSize = Convert.ToInt32(args[0]);
            int WPage = Convert.ToInt32(args[1]);
            string LogReport = " ============================================================================= \n" + dtNow + " Start                    " + DateTime.Now + " \n" + " ============================================================================= \n";
            ...
            string UrlLink = String.Format("http://automationapi.mobinsb.com/api/external/Bourse/GetCustomerGroups?PageSize={0}&PageNumber={1}", WPageSize, WPage);
