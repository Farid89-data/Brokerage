...
namespace GetRequestMasterStockMarket
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string UrlLink = String.Format("http://automationapi.mobinsb.ir/api/External/Bourse/GetRequestMasterStockMarket?ToDate={0}&FromDate={1}&PageSize={2}&PageNumber={3}", EndDate, StartDate, WPageSize, WPage);
