...
namespace CalculateCompanyBranchRank
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string UrlLink = String.Format("http://automationapi.mobinsb.ir/api/External/Bourse/CalculateCompanyBranchRank?StartDate={0}&EndDate={1}&CommissionCoefficient={2}&CustomerCoefficient={3}&ChangeBrokerCoefficient={4}", StartDate, EndDate, CommissionCoefficient, CustomerCoefficient, ChangeBrokerCoefficient);
